...
class SecurityExchangeV1(Transaction):
    ...
    @classmethod
    def deserialize(cls, serialized_transaction: bytes) -> 'SecurityExchangeV1':
        """Replace Placeholder Docstring."""
        payment_proto = proto.BlockchainTxn.FromString(serialized_transaction).security_exchange
    ...
    def to_proto(self, for_signing=False) -> proto.BlockchainTxn:
        """Replace Placeholder Docstring."""
        return proto.BlockchainTxn(security_exchange=proto.BlockchainTxnSecurityExchangeV1(
